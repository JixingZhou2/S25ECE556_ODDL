...
# Model and training
We use YOLOv11-small as our base model, trained on the dataset from the Pose Counting Repetition Computer Vision Project. The training process is handled by src/train.py, which:
